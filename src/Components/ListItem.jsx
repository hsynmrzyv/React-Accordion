    ...
    >
      <div className={classes.liTopClasses}>
        <button className={classes.collapseBtnClasses}>
          {props.singleQuestion.show && <AiOutlineMinus />}
          {!props.singleQuestion.show && <AiOutlinePlus />}
        </button>
      ...
      {props.singleQuestion.show && (
        <div className={classes.liBottomClasses}>
          <p className={classes.textClasses}>{props.singleQuestion.answer}</p>
